...
<?php
    ...
    if (!isset($_GET['kode'])) {
        echo '<script>alert("Kode Mata Kuliah Tidak Sesuai");window.location.href=\'../matkul\';</script>';
    } else {
        $search = $_GET['kode'];
        $sql = "SELECT *
                FROM matkul
                WHERE kode_matkul='$search'";
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control" minlength="3" maxlength="5" name="kode_matkul" value="<?php echo $matkul['kode_matkul']?>" readonly>
                                        </div>
