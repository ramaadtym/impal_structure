                ...
                <div class="card">
                    <div class="header">
                        ...
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                <a href="addMhsKls.php?kode=<?php echo $kode_kelas ?>" role="button">
                                ...
                                foreach ($kelas as $value) {
                                    echo "
                                            <tr>
                                                ...
                                                <td>".$value['id_line']."</td>
                                                <td>
                                                <a href='delMhsKls.php?kode=$kode_kelas&nim=$value[nim]'>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <select class="form-control show-tick" name="kode" required>
                                        ...
                                        <?php
                                            $sql = "SELECT kode_kelas from kelas ORDER BY kode_kelas ASC";
                                            $kelas = mysqli_query($connect,$sql);
                                            if(mysqli_num_rows($kelas) == 0){
